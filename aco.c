/*
      ...
      AA  AA   CCCC   OOOO    QQQQQ  AA  AA PP
                                   Q
######################################################
#######    ACO algorithms for the TSP / QAP    #######
######################################################

      Version: 1.0
      File:    aco.c
      Author:  Thomas Stuetzle, Manuel Lopez-Ibanez
      Purpose: main routines and control for the ACO algorithms for the TSP and the QAP
      Check:   README and gpl.txt
      Copyright (C) 2002, 2015 Thomas Stuetzle, Manuel Lopez-Ibanez
*/

/***************************************************************************

    Program's name: acoqap or acotsp

    Ant Colony Optimization algorithms (AS, ACS, EAS, RAS, MMAS, BWAS) for the QAP

    Copyright (C) 2004, 2015  Thomas Stuetzle, Manuel Lopez-Ibanez
