...
#define STR_HELP_TSPLIBFILE \
  "  -i, --tsplibfile     f inputfile (TSPLIB or QAPLIB+ format necessary)\n"

#define STR_HELP_OPTIMUM \
  "  -o, --optimum        # stop if solution better or equal optimum is found\n"
...
#define STR_HELP_DLB \
  "  -d, --dlb            1 use don't look bits in first-improvement local search\n"
